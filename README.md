...
这里主要是用来记录我R语言的学习过程，包括看过的相关书籍，阅读过的有关博文，深入了解的一些包以及其他的一些资源。

## Books

-   [R in Action](https://www.manning.com/books/r-in-action-third-edition)
...
- [Map rivers with sf and ggplot2 in R](https://milospopovic.net/map-rivers-with-sf-and-ggplot2-in-r/)
- [6 easy ways to map population density in R](https://milospopovic.net/6-ways-to-map-population-with-r.r/)
- [Rayshader Tutorial—Florida Population Density](https://www.youtube.com/watch?v=zgFXVhmKNbU)
## Packages
...
-   [Rehsape2](https://github.com/hadley/reshape)
-   [Forecast](https://pkg.robjhyndman.com/forecast/)
-   [fpp3](https://github.com/robjhyndman/fpp3package)
